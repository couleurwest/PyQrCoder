...
def minify_css(directory:str, css_map: list):
...
if __name__ == "__main__":
    ...
    directory =  profiler.path_build(directory, 'wwwproject')
    print(directory)
    js_file = profiler.path_build(directory, 'js')

    # Map scss source files to css destination files
    css_map = ['basis', 'qrcoder']
